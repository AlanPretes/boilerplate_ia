...
class PlateConfig(AppConfig):
    ...
    def ready(self):
        ...
        self.model_letters_new_moto = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_new_moto_.pt'))
        ...
        self.model_letters_new_car_0_180 = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_new_moto_.pt'))
        self.model_letters_old_car_45_225 = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_old_moto.pt'))
        self.model_letters_new_car_45_225 = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_new_moto_.pt'))
        self.model_letters_old_car_135_315 = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_old_moto.pt'))
        self.model_letters_new_car_135_315 = YOLO(os.path.join(os.path.dirname(__file__), 'ias_models/letras_new_moto_.pt'))
